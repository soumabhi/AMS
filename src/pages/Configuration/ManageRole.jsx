...
/>
  ...
  />
      ...
      {deleteConfirm && (
        ...
        >
          <div className="bg-white rounded-lg shadow-2xl max-w-md w-full mx-4 border border-gray-200 transform transition-all"></div>
          <div className="p-6">
              ...
              <p className="text-gray-700 mb-6">
                Are you sure you want to delete the role <strong>"{deleteConfirm.role}"</strong>? 
